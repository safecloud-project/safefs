...
off_t nop_get_file_size(const char* path, off_t origin_size, struct fuse_file_info *fi, struct fuse_operations nextlayer){
...
uint64_t nop_get_cyphered_block_offset(uint64_t origin_offset){
