...
void erasure_destroy() { liberasurecode_instance_destroy(liberasurecode_instance); }
...
char *decode(const encoded_file_t *encoded_data) {
    ...
    liberasurecode_decode(liberasurecode_instance, encoded_data->data_blocks, K, encoded_data->fragment_size, 0,
                          &buffer, &decoded_data_length);
