...
int handle_section_layers(configuration* config,
                          const char* name,
                          const char* value){
...
int handle_section_block_align(configuration* config,
                          const char* name,
                          const char* value){
...
int handle_section_sfuse(configuration* config,
                          const char* name,
                          const char* value){
...
int handle_section_multi_loop(configuration* config,
                              const char* name,
                              const char* value)
{
...
int handle_section_log(configuration* config,
                       const char* name,
                       const char* value) {
  if (strcmp(name, "mode") == 0) {
